                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div align="right" class="mb-3">
                                            <a href="tambah-pendidikan.php" class="btn btn-primary">Tambah</a>
                                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($query)) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="tambah-pendidikan.php?edit=<?php echo $row['id'] ?>" class="btn btn-success btn-sm">
                                                                <span class="tf-icon bx bx-pencil bx-18px"></span></a>
                                                            <a onclick="return confirm('Apakah anda yakin akan menghapus data ini?')"
                                                                href="pendidikan.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm">
