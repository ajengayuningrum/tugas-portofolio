                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">Data Skill</div>
                                    <div class="card-body">
                                        ...
                                        <div align="right" class="mb-3">
                                            <a href="tambah-skills.php" class="btn btn-primary">Tambah</a>
                                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($query)) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['deskripsi_skill'] ?></td>
                                                        <td>
                                                            <a href="tambah-skills.php?edit=<?php echo $row['id'] ?>" class="btn btn-success btn-sm">
                                                                <span class="tf-icon bx bx-pencil bx-18px"></span></a>
                                                            <a onclick="return confirm('Apakah anda yakin akan menghapus data ini?')"
                                                                href="skills.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm">
