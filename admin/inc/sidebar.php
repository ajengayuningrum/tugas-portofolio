<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="data-diri.php" class="menu-link" target="_blank">
                        <div data-i18n="Basic">Data Diri</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="resume.php" class="menu-link" target="_blank">
                        <div data-i18n="Basic">Data Resume</div>
                    </a>
                </li>
                <li class="menu-item">
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Misc">Data Skills</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="skills.php" class="menu-link">
                        <div data-i18n="Error">Skills</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="portofolio.php" class="menu-link">
                        <div data-i18n="Under Maintenance">Portfolio</div>
                    </a>
                </li>
            </ul>
        </li>
